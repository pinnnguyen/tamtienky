...
//            $tupocmd = $encode->encode("cmd=tupo&sid=$sid");
            ...
            $tpts = "<p class='p-2 text-white text-xs bg-[#36445a] absolute z-[999]'><strong>Tip: </strong>Bạn cần đột phá, nếu không sẽ không thể tích lũy được kinh nghiệm:$tupocmd</p>";
        }
