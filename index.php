...
<form action=<?php echo $_SERVER['PHP_SELF']; ?> method="post">
    ...
    <input type="text" name="username" placeholder="Tài khoản" class="input" value="<?php if(!empty($username)) echo $username; ?>"/><br/>

    <input type="password" name="userpass" placeholder="Mật khẩu" class="input" value="<?php if(!empty($userpass)) echo $userpass; ?>"/><br/>
    <?php echo $a ?>
